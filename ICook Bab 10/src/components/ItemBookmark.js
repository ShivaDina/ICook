...
import {Bookmark2, Clock, Message} from 'iconsax-react-native';
            ...
            <View>
              <View style={styles.cardIcon}>
                <TouchableOpacity onPress={onPress}>
                  <Bookmark2 color={colors.choco()} variant={variant} size={20} />
                </TouchableOpacity>
              </View>
            </View>
          </View>
...
const styles = StyleSheet.create({
  cardItem: {
    backgroundColor: colors.brown(0.03),
    borderRadius: 15,
  },
  cardImage: {
    width: '100%',
  ...
  cardIcon: {
    backgroundColor: colors.choco(0.33),
    padding: 5,
